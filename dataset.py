...
class DataList(IterableDataset):
    ...
    def __iter__(self):
     ...
     #  print("start print file id:")
      #  sys.stderr.write("start print file id")
        os.write(2,b"start print file id\n")
        for index in indexes:
            # yield dict(src=src)
            os.write(2,bytes(self.lists[index]+"\n" ,'utf-8'))
...
def Dataset(data_type, data_list_file, symbol_table, conf,
    ...
    print("dataset 111111111111111111111111111111111111")
